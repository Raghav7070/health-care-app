...
diabetes_model = pickle.load(open(f'Multiple_Disease_Prediction/saved_models/diabetes.pkl','rb'))
heart_disease_model = pickle.load(open(f'Multiple_Disease_Prediction/saved_models/heart.pkl','rb'))
kidney_disease_model = pickle.load(open(f'Multiple_Disease_Prediction/saved_models/kidney.pkl','rb'))
